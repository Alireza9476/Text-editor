...
public class Editor {
 ...
 //Für ein Button erstellen wir ein Actionhandler
...
public void actionPerformed(ActionEvent event) {
    try {
		...
		if (userSelection == JFileChooser.APPROVE_OPTION) {			
			File fileToSave = fileChooser.getSelectedFile();	//Auswählte Datei eines Users wird gespeichert und dessen Pfad wird im späteren Ablauf für die Speicherung genutzt.
